        ...
        <div>
            ...
            <section className='paymentForm'>
                <form onSubmit={handlePaymentBtn} >
                    ...
                    <div style={{ display: 'flex', justifyContent: 'start', alignItems: 'center' }}>
                        <p style={{ fontWeight: '600', backgroundColor: 'orange', border: '2px solid orange', padding: '4px', borderRadius: '5px 0 5px 0', width: '100px' }}>Name:</p><input type="text" className='nameInputpay' placeholder='Please Enter Name' style={{ marginLeft: '-4px' }} />
                    </div>
                    <div className='sameLinePay'>
                        <div style={{ display: 'flex', justifyContent: 'start', alignItems: 'center' }}>
                            <p style={{ fontWeight: '600', backgroundColor: 'orange', border: '2px solid orange', padding: '4px', borderRadius: '5px 0 5px 0', width: '100px' }}>Class:</p><input type="number" className='idInput' placeholder='Please Enter Class' style={{ marginLeft: '-4px' }} />
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'start', alignItems: 'center' }}>
